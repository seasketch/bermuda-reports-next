...
/**
 * renewableEnergyWorker: A geoprocessing function that calculates overlap metrics
 * @param sketch - A sketch or collection of sketches
 * @param extraParams
 * @returns Calculated metrics and a null sketch
 */
export async function renewableEnergyWorker(
  sketch:
...
export default new GeoprocessingHandler(renewableEnergyWorker, {
  title: "renewableEnergyWorker",
  description: "",
  timeout: 500, // seconds
