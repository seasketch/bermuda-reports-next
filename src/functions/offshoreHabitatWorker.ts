...
/**
 * offshoreHabitatWorker: A geoprocessing function that calculates overlap metrics
 * @param sketch - A sketch or collection of sketches
 * @param extraParams
 * @returns Calculated metrics and a null sketch
 */
export async function offshoreHabitatWorker(
  sketch:
...
export default new GeoprocessingHandler(offshoreHabitatWorker, {
  title: "offshoreHabitatWorker",
  description: "",
  timeout: 500, // seconds
