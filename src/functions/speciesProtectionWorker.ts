...
/**
 * speciesProtectionWorker: A geoprocessing function that calculates overlap metrics
 * @param sketch - A sketch or collection of sketches
 * @param extraParams
 * @returns Calculated metrics and a null sketch
 */
export async function speciesProtectionWorker(
  sketch:
...
export default new GeoprocessingHandler(speciesProtectionWorker, {
  title: "speciesProtectionWorker",
  description: "",
  timeout: 500, // seconds
