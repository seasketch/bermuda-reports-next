...
/**
 * ousSectorWorker: A geoprocessing function that calculates overlap metrics
 * @param sketch - A sketch or collection of sketches
 * @param extraParams
 * @returns Calculated metrics and a null sketch
 */
export async function ousSectorWorker(
  sketch:
...
export default new GeoprocessingHandler(ousSectorWorker, {
  title: "ousSectorWorker",
  description: "",
  timeout: 500, // seconds
