...
/**
 * habitatRestoration: A geoprocessing function that calculates overlap metrics
 * @param sketch - A sketch or collection of sketches
 * @param extraParams
 * @returns Calculated metrics and a null sketch
 */
export async function habitatRestoration(
  sketch:
  ...
  const metricGroup = project.getMetricGroup("habitatRestoration");
  const metrics = (
    await Promise.all(
...
export default new GeoprocessingHandler(habitatRestoration, {
  title: "habitatRestoration",
  description: "overlap with habitat restoration areas",
  timeout: 500, // seconds
