...
/**
 * NearshoreHabitat component
 *
 * @param props - geographyId
 * @returns A react component which displays an overlap report
 */
export const NearshoreHabitat: React.FunctionComponent<GeogProp> = (props) => {
  ...
  // Metrics
  const metricGroup = project.getMetricGroup("nearshoreHabitat", t);
  ...
  // Labels
  const titleLabel = t("Habitat Protection - Nearshore");
    ...
    >
      {(data: ReportResult) => {
        ...
        return (
          <ReportError>
            <p>
              <Trans i18nKey="NearshoreHabitat 1">
            ...
            <LayerToggle
              ...
              label="Show Nearshore Habitats On Map"
            />
            ...
            <Collapse title={t("Learn More")}>
              <Trans i18nKey="NearshoreHabitat - learn more">
                <p>
